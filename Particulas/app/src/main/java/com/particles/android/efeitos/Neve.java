...
public class Neve {
    ...
    // -- [ MÉTODO CONSTRUTOR ] --
    public Neve(Geometry.Point posicao, Geometry.Vector direcao, int cor, float angulo, float velocidade) {
    ...
    public void addParticulas(SistemaParticulas sistemaParticulas, float tempoAtual, int quantidade) {
        for (int i = 0; i < quantidade; i++) {
            ...
            // Randomizando valores de posição X e extras particula
            ...
            sistemaParticulas.addParticula(new Geometry.Point(posX,posicao.y,posicao.z), cor, direcaoParticula, tempoAtual);
        }
