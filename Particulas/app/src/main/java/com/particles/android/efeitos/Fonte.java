...
public class Fonte {
    ...
    // -- [ MÉTODO CONSTRUTOR ] --
    public Fonte(Geometry.Point posicao, Geometry.Vector direcao, int cor, float angulo, float velocidade)
    {
    ...
    public void addParticulas(SistemaParticulas sistemaParticulas, float tempoAtual, int quantidade) {
        ...
        /*Obs: Uma simples estutura de repetição que adiciona a quantidade definida na fonte de particulas ao sistema*/
    }
